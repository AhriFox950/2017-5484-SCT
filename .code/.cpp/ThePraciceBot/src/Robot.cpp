...
public:
	...
	void OperatorControl() override
	{
		...
		while (IsOperatorControl() && IsEnabled())
		{
			...
			std::cout << "Yaw:    " << ahrs->GetAngle() << std
					/::endl;
			driveTrain.TankDrive((joystick0.GetRawAxis(5) * 0.7) + (0.3 / joystick0.GetRawAxis(3)), (joystick0.GetRawAxis(1) * 0.7) + (0.3 / joystick0.GetRawAxis(3)));
			}
